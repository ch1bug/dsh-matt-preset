...
description: >
  ...
  EXPLICIT INVOCATION ONLY — activate when the user says "ponytail", "be
  lazy", "lazy mode", "simplest solution", "minimal solution", "yagni",
  "do less", or "shortest path"; "stop ponytail" reverts. Never self-activate
  on over-engineering complaints alone, and NEVER for review/audit/receipt-
  checking tasks — auditing runs the ticket-audit skill, which is exempt
  from this ladder.
argument-hint: "[lite|full|ultra]"
license: MIT
---

# Ponytail（vendored into dsh-matt-preset）
...
> (MIT, © DietrichGebert) — dsh-matt-preset vendored copy. Matt-workflow
> integration clauses at the bottom; everything else tracks upstream.
...
## Matt-workflow integration（本仓库新增，优先级高于上游默认）
...
3. **七门不受影响**：阶梯作用于实现代码的形态，不作用于流程门禁
   （审计/push 确认/批末总结照常）。
